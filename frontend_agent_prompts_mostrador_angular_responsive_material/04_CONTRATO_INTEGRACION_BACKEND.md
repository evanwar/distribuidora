...
La cobertura funcional exacta se controla en `06_MATRIZ_ENDPOINTS_FRONTEND.md`: 128 operaciones distribuidas entre F0 y F01-F09. Los contratos detallados de request, response, parámetros y errores están en `../Distribuidora/docs/frontend-api/`; la colección de apoyo está en `../Distribuidora/postman/Distribuidora.Api.postman_collection.json`.
